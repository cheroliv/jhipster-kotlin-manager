...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, ceelo.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, ceelo.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, ceelo.domain.User::class.java.name)
            createCache(cm, ceelo.domain.Authority::class.java.name)
            createCache(cm, ceelo.domain.User::class.java.name + ".authorities")
