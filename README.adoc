...
. "Si le jet est un triplet uniforme alors la propriété isTriplet renvoi un true"
. "Si le jet est un triplet uniforme alors la propriété tripletUniformeValue renvoi la valeur faciale du dé"
