...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dices-run.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DICESRUN_LIST actions', async () => {
    ...
    it('dispatches FETCH_DICESRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DICESRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DICESRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DICESRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DICESRUN actions', async () => {
      const expectedActions = [
        {
