  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ceeloApp.player.home.createOrEditLabel" data-cy="PlayerCreateUpdateHeading">
            <Translate contentKey="ceeloApp.player.home.createOrEditLabel">Create or edit a Player</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="player-id"
                  label={translate('ceeloApp.player.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('ceeloApp.player.login')}
                id="player-login"
                name="login"
                data-cy="login"
                type="text"
