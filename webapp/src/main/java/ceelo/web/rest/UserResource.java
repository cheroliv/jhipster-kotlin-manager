...
import ceelo.config.Constants;
import ceelo.domain.User;
import ceelo.repository.UserRepository;
import ceelo.security.AuthoritiesConstants;
import ceelo.service.MailService;
import ceelo.service.UserService;
import ceelo.service.dto.AdminUserDTO;
import ceelo.web.rest.errors.BadRequestAlertException;
import ceelo.web.rest.errors.EmailAlreadyUsedException;
import ceelo.web.rest.errors.LoginAlreadyUsedException;
import java.net.URI;
 ...
 * <p>
 * This class accesses the {@link ceelo.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
