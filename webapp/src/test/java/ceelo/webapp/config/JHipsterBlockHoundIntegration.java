...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ceelo.webapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ceelo.webapp.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
