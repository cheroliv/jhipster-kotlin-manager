...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.cheroliv.ceelo.webapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.cheroliv.ceelo.webapp.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
