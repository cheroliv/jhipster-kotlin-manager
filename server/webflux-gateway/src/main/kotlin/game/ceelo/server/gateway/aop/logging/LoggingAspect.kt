package game.ceelo.server.gateway.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(game.ceelo.server.gateway.repository..*)" +
            " || within(game.ceelo.server.gateway.service..*)" +
            " || within(game.ceelo.server.gateway.web.rest..*)"
    )
