...
import game.ceelo.server.gateway.security.getCurrentUserLogin
import game.ceelo.server.gateway.service.MailService
import game.ceelo.server.gateway.service.UserService
import game.ceelo.server.gateway.service.dto.AdminUserDTO
import game.ceelo.server.gateway.service.dto.PasswordChangeDTO
import game.ceelo.server.gateway.web.rest.errors.EmailAlreadyUsedException
import game.ceelo.server.gateway.web.rest.errors.InvalidPasswordException
import game.ceelo.server.gateway.web.rest.errors.LoginAlreadyUsedException
import game.ceelo.server.gateway.web.rest.vm.KeyAndPasswordVM
import game.ceelo.server.gateway.web.rest.vm.ManagedUserVM
