...
import game.ceelo.server.gateway.IntegrationTest.Companion.DEFAULT_TIMEOUT
import game.ceelo.server.gateway.config.DEFAULT_LANGUAGE
import game.ceelo.server.gateway.config.SYSTEM_ACCOUNT
import game.ceelo.server.gateway.domain.User
import game.ceelo.server.gateway.repository.AuthorityRepository
