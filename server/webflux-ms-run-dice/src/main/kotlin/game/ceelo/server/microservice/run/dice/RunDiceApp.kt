package game.ceelo.server.microservice.run.dice

import game.ceelo.server.microservice.run.dice.config.ApplicationProperties
...
class RunDiceApp(private val env: Environment) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<RunDiceApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(RunDiceApp::class.java)
