package game.ceelo.server.ms.stats.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(game.ceelo.server.ms.stats.repository..*)" +
            " || within(game.ceelo.server.ms.stats.service..*)" +
            " || within(game.ceelo.server.ms.stats.web.rest..*)"
    )
