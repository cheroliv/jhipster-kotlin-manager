package game.ceelo.server.ms.stats

import game.ceelo.server.ms.stats.config.ApplicationProperties
...
class StatsApp(private val env: Environment) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<StatsApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(StatsApp::class.java)
