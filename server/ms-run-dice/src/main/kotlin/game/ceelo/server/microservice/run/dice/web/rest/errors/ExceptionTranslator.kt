package game.ceelo.server.microservice.run.dice.web.rest.errors
...
class ExceptionTranslator(private val env: Environment) : ProblemHandling, SecurityAdviceTrait {
    ...
    private fun containsPackageName(message: String?) = listOf("org.", "java.", "net.", "javax.", "com.", "io.", "de.", "game.ceelo.server.microservice.run.dice").any { it == message }
}
