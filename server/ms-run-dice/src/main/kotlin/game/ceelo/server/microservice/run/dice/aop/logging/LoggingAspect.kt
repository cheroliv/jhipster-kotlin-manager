package game.ceelo.server.microservice.run.dice.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(game.ceelo.server.microservice.run.dice.repository..*)" +
            " || within(game.ceelo.server.microservice.run.dice.service..*)" +
            " || within(game.ceelo.server.microservice.run.dice.web.rest..*)"
    )
