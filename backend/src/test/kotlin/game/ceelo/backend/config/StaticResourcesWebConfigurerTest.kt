...
import game.ceelo.backend.config.StaticResourcesWebConfiguration.Companion.RESOURCE_LOCATIONS
import game.ceelo.backend.config.StaticResourcesWebConfiguration.Companion.RESOURCE_PATHS
