...
import game.ceelo.backend.IntegrationTest
import game.ceelo.backend.config.DEFAULT_LANGUAGE
import game.ceelo.backend.domain.User
import game.ceelo.backend.repository.AuthorityRepository
import game.ceelo.backend.repository.UserRepository
import game.ceelo.backend.security.ADMIN
import game.ceelo.backend.security.USER
