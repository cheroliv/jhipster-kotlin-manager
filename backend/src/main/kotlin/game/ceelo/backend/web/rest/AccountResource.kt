package game.ceelo.backend.web.rest

import game.ceelo.backend.repository.UserRepository
import game.ceelo.backend.security.getCurrentUserLogin
import game.ceelo.backend.service.MailService
import game.ceelo.backend.service.UserService
import game.ceelo.backend.service.dto.AdminUserDTO
import game.ceelo.backend.service.dto.PasswordChangeDTO
import game.ceelo.backend.web.rest.errors.EmailAlreadyUsedException
import game.ceelo.backend.web.rest.errors.InvalidPasswordException
import game.ceelo.backend.web.rest.errors.LoginAlreadyUsedException
import game.ceelo.backend.web.rest.vm.KeyAndPasswordVM
import game.ceelo.backend.web.rest.vm.ManagedUserVM
