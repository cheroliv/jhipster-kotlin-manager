package game.ceelo.backend.config
...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, game.ceelo.backend.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, game.ceelo.backend.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, game.ceelo.backend.domain.User::class.java.name)
            createCache(cm, game.ceelo.backend.domain.Authority::class.java.name)
            createCache(cm, game.ceelo.backend.domain.User::class.java.name + ".authorities")
