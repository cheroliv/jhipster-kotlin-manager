package game.ceelo.backend

import game.ceelo.backend.config.ApplicationProperties
...
class CeeLoBackEndApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes CeeLoBackEnd.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<CeeLoBackEndApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(CeeLoBackEndApp::class.java)
