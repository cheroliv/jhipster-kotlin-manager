...
class CeeloUnitTest {
    ...
    fun `Si le jet est un triplet uniforme alors la propriété isUniformTriplet renvoi un true`() {
        assertEquals(true, `1_1_1`.isUniformTriplet)
        assertEquals(true, `2_2_2`.isUniformTriplet)
        assertEquals(true, `3_3_3`.isUniformTriplet)
        assertEquals(true, `4_4_4`.isUniformTriplet)
        assertEquals(true, `5_5_5`.isUniformTriplet)
        assertEquals(true, `6_6_6`.isUniformTriplet)
        assertEquals(false, `4_5_6`.isUniformTriplet)
        assertEquals(false, `1_2_3`.isUniformTriplet)
    }

    @Test
    fun `Si le jet est un triplet uniforme alors la propriété tripletUniformeValue renvoi la valeur facial du dé`() {
